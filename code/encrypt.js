...
Tea.base64Encode = function(str) {
    ...
    if (typeof Buffer != 'undefined') return new Buffer(str, 'binary').toString('base64'); // Node
...
Tea.base64Decode = function(b64Str) {
    ...
    try {
        ...
        if (typeof Buffer != 'undefined') return new Buffer(b64Str, 'base64').toString('binary'); // Node
    } catch (e) {
